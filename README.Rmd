...
- [Register as an Apple developer (for free)](https://apps.apple.com/cn/app/apple-developer/id640199958/)
...
- Install the current release of full [Xcode from the Mac App Store](https://apps.apple.com/ca/app/xcode/id497799835?mt=12)
