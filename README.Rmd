...
Please ensure that **Rcpp** is properly installed and the appropriate **C++** compilation environment is configured in advance if you want to install **geocomplexity** from [github](https://github.com/SpatLyu/geocomplexity).
