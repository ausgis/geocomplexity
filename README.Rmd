...
You can install the development version of **geocomplexity** from [github](https://github.com/ausgis/geocomplexity) with:
...
You can also install the binary version of **geocomplexity** from [r-universe](https://ausgis.r-universe.dev/geocomplexity):
