...
// BasicGWRFit
Rcpp::List BasicGWRFit(arma::vec y, arma::mat X, arma::mat Cdist, double bw, std::string kernel);
RcppExport SEXP _geocomplexity_BasicGWRFit(SEXP ySEXP, SEXP XSEXP, SEXP CdistSEXP, SEXP bwSEXP, SEXP kernelSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(BasicGWRFit(y, X, Cdist, bw, kernel));
    return rcpp_result_gen;
END_RCPP
}
// GeoCGWRFit
Rcpp::List GeoCGWRFit(arma::vec y, arma::mat X, arma::vec gcs, arma::mat Cdist, double bw, double alpha, std::string kernel);
RcppExport SEXP _geocomplexity_GeoCGWRFit(SEXP ySEXP, SEXP XSEXP, SEXP gcsSEXP, SEXP CdistSEXP, SEXP bwSEXP, SEXP alphaSEXP, SEXP kernelSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type kernel(kernelSEXP);
    rcpp_result_gen = Rcpp::wrap(GeoCGWRFit(y, X, gcs, Cdist, bw, alpha, kernel));
    return rcpp_result_gen;
END_RCPP
}
// InforEntropy
...
static const R_CallMethodDef CallEntries[] = {
    {"_geocomplexity_BasicGWRFit", (DL_FUNC) &_geocomplexity_BasicGWRFit, 5},
