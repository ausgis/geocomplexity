...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type start_idx(start_idxSEXP);
    Rcpp::traits::input_parameter< double >::type end_idx(end_idxSEXP);
...
// GeoCGWR
Rcpp::List GeoCGWR(arma::vec y, arma::mat X, arma::mat gcs, arma::mat Gdist, double bw, double knn, bool adaptive, double alpha, std::string kernel);
RcppExport SEXP _geocomplexity_GeoCGWR(SEXP ySEXP, SEXP XSEXP, SEXP gcsSEXP, SEXP GdistSEXP, SEXP bwSEXP, SEXP knnSEXP, SEXP adaptiveSEXP, SEXP alphaSEXP, SEXP kernelSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< std::string >::type kernel(kernelSEXP);
    rcpp_result_gen = Rcpp::wrap(GeoCGWR(y, X, gcs, Gdist, bw, knn, adaptive, alpha, kernel));
    return rcpp_result_gen;
END_RCPP
}
// InforEntropy
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type coefmat(coefmatSEXP);
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type coefname(coefnameSEXP);
    PrintGCGWRM(x, coefmat, coefname);
    return R_NilValue;
END_RCPP
}
// RasterGeoCMoranOne
